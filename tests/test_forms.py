...
from mongoengine import queryset_manager, connect, Document, EmbeddedDocument
...
class WTFormsAppTestCase(unittest.TestCase):
    ...
    def setUp(self):
        self.db_name = 'wtform_mongoengine_testing'
    ...
    def test_unique_with(self):
        class Item (Document):
            ...
            owner_item_id = StringField(required=True, unique_with='owner_id')
